...
# Use dotenv for initial seeding ONLY if config.yaml is missin
...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "paths": {
        ...
        "output": "/tmp/outputs",
        "voices": "/root/dia-tts-server/voices",  # Added predefined voices path
    },
    "generation_defaults": {
...
def get_model_cache_path() -> str:
    # Inside Modal container, model volume is mounted here
    return "/model_cache"
